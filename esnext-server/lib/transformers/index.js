...
exports.useTransformers = (0, nano_memoize_1.default)((options) => {
    var _a, _b;
    const { htmlTransformer } = (0, html_transformer_1.useHtmlTransformer)(options);
    const { esbuildTransformer } = (0, esbuild_transformer_1.useEsBuildTransformer)(options);
    const { babelTransformer } = (0, babel_transformer_1.useBabelTransformer)(options);
    const { sassTransformer } = (0, sass_transformer_1.useSassTransformer)(options);
    const include = ((_a = options.transform) === null || _a === void 0 ? void 0 : _a.include) && (0, picomatch_1.default)(options.transform.include);
    const exclude = ((_b = options.transform) === null || _b === void 0 ? void 0 : _b.exclude) && (0, picomatch_1.default)(options.transform.exclude);
