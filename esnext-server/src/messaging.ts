...
export type MessagingContext = { on: OnMessage, broadcast: SendMessage, options: ESNextOptions, watcher: FSWatcher };
...
export const useMessaging = memoized((options: ESNextOptions) => {
